// app/(fotografi)/fotograf-onesti-dragoi-george-adrian/SocialLinks.tsx
'use client';
...
export default function SocialLinks({ provider }: { provider: any }) {
  return (
    <>
      {provider.instagram_url && (
        <a href={provider.instagram_url} target="_blank" rel="noopener noreferrer" className="fp-conn-row" onClick={() => track(provider.slug)}>
      ...
      {provider.facebook_url && (
        <a href={provider.facebook_url} target="_blank" rel="noopener noreferrer" className="fp-conn-row" onClick={() => track(provider.slug)}>
          <div className="fp-conn-l">
      ...
      {provider.website_url && (
        <a href={provider.website_url} target="_blank" rel="noopener noreferrer" className="fp-conn-row" onClick={() => track(provider.slug)}>
          <div className="fp-conn-l">
