...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    siteName: 'VibeInvite',
    url: 'https://www.vibeinvite.ro/invitatie-botez-baieti-masina',
    title: 'Invitație Botez Băiat Mașină de Curse — VibeInvite',
    ...
    images: [{ url: 'https://www.vibeinvite.ro/og-botez-masina.jpg', width: 1200, height: 630, alt: 'Invitație Botez Mașină de Curse' }],
  },
  alternates: { canonical: 'https://www.vibeinvite.ro/invitatie-botez-baieti-masina' },
}
