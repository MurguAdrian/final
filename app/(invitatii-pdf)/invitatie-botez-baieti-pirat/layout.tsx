...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.vibeinvite.ro/invitatie-botez-baieti-pirat',
    title: 'Invitație Botez Băiat Pirat — VibeInvite',
    description: 'Design pirat cu hartă de comoară, valuri și pavillon negru. 30 lei, plată unică.',
    images: [{ url: 'https://www.vibeinvite.ro/og-botez-pirat.jpg', width: 1200, height: 630, alt: 'Invitație Botez Pirat' }],
  },
  alternates: { canonical: 'https://www.vibeinvite.ro/invitatie-botez-baieti-pirat' },
}
