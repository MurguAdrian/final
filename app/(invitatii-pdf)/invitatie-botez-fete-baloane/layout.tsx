...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://vibeinvite.ro/invitatie-botez-fete-baloane',
    ...
    images: [{ url: 'https://vibeinvite.ro/og-botez-fete-baloane.jpg', width: 1200, height: 630, alt: 'Invitație Botez Fată Baloane' }],
  },
  alternates: { canonical: 'https://vibeinvite.ro/invitatie-botez-fete-baloane' },
}
