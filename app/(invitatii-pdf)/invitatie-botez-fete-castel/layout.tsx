...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://vibeinvite.ro/invitatie-botez-fete-castel',
    title: 'Invitație Botez Fată Prințesă Castel — VibeInvite',
    description: 'Design regal cu castel, coroană aurie și stele — pentru mica prințesă. PDF + JPG. 30 lei.',
    images: [{ url: 'https://vibeinvite.ro/og-botez-fete-castel.jpg', width: 1200, height: 630, alt: 'Invitație Botez Prințesă' }],
  },
  alternates: { canonical: 'https://vibeinvite.ro/invitatie-botez-fete-castel' },
}
