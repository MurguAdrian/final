...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://vibeinvite.ro/invitatie-botez-fete-roz',
    ...
    images: [{ url: 'https://vibeinvite.ro/og-botez-fete-roz.jpg', width: 1200, height: 630, alt: 'Invitație Botez Fată Roz' }],
  },
  alternates: { canonical: 'https://vibeinvite.ro/invitatie-botez-fete-roz' },
}
