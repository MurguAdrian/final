...
.vr-parents-name {
  ...
  color: #1B3B2B; line-height: 2; letter-spacing: .04em; text-align: center;
}
.vr-parents-and {
  font-size: 7px; letter-spacing: .28em; text-transform: uppercase;
  color: #5F8575; margin: 2px 0; display: block; text-align: center;
}
...
.vr-sep { width: 40px; height: 1px; background: #5F8575; opacity: .5; margin: 0 auto 24px; }
.vr-date-main {
  font-family: 'Cormorant Garamond', serif;
  font-size: 22px; font-weight: 300; font-style: italic;
  color: #1B3B2B; letter-spacing: .06em; text-align: center; margin-bottom: 4px;
}
.vr-date-year {
...
.vr-event { text-align: center; padding: 16px 12px; }
...
.vr-sep2 { width: 40px; height: 1px; background: #5F8575; opacity: .4; margin: 0 auto 20px; }
.vr-nasi-label {
  font-size: 7px; font-weight: 500;
  letter-spacing: .24em; text-transform: uppercase;
