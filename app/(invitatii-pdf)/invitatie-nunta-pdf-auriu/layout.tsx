...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    siteName: 'VibeInvite',
    url: 'https://vibeinvite.ro/invitatie-nunta-pdf-auriu',
    title: 'Invitație Nuntă PDF Auriu — VibeInvite',
    description: 'Design auriu elegant pentru nunta ta. Personalizabil, descarcabil instant în PDF și JPG. 30 lei, plată unică.',
    images: [{ url: 'https://vibeinvite.ro/og-invitatie-auriu.jpg', width: 1200, height: 630, alt: 'Invitație Nuntă PDF Auriu' }],
  },
  alternates: { canonical: 'https://vibeinvite.ro/invitatie-nunta-pdf-auriu' },
}
