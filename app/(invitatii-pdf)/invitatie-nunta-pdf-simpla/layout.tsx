...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    siteName: 'VibeInvite',
    url: 'https://vibeinvite.ro/invitatie-nunta-pdf-simpla',
    title: 'Invitație Nuntă Simplă Elegantă — VibeInvite',
    ...
    images: [{ url: 'https://vibeinvite.ro/og-invitatie-simpla.jpg', width: 1200, height: 630, alt: 'Invitație Nuntă Simplă Elegantă' }],
  },
  alternates: { canonical: 'https://vibeinvite.ro/invitatie-nunta-pdf-simpla' },
}
