...
export default function CheckoutPage() {
  ...
  const filteredThemes =
    activeTab === "toate"
      ? THEMES
      : THEMES.filter((t) => t.category === activeTab);
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: isActive ? "#1A1208" : "#fff",
                      color: isActive ? "#fff" : "rgba(26,18,8,0.6)",
                      fontSize: 13,
                      ...
                      touchAction: "manipulation",
                      minHeight: 44,
                      boxShadow: isActive ? "0 2px 8px rgba(26,18,8,0.15)" : "none",
                    }}
                  >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {filteredThemes.length === 0 ? (
              <div style={{
                ...
                <strong style={{ display: "block", color: "rgba(26,18,8,0.65)", marginBottom: 4 }}>
                  În curând
                </strong>
