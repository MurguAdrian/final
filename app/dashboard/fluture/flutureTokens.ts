export const C = {
  ...
  // Text
  text:         '#7A2E4D',   // roz-vișiniu elegant
  textSub:      '#9B4C6A',
  textMuted:    '#B87893',
  textFaint:    'rgba(155,76,106,.45)',
  ...
  // Borders
  border:       'rgba(227,90,135,.18)',
  borderFaint:  'rgba(227,90,135,.08)',
  borderLight:  'rgba(247,193,213,.35)',
  borderMed:    'rgba(227,90,135,.35)',
  borderStrong: 'rgba(201,71,114,.45)',
  borderGold:   'rgba(244,208,111,.45)',
  borderAccent: 'rgba(227,90,135,.35)',
