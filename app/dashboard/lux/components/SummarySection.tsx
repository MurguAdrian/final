...
export const SummarySection = ({ isComplete }: SummaryProps) => {
  ...
  const stats = [
    ...
    { label: 'Confirmări', value: data?.stats?.da || 0 },
    { label: 'Total Persoane', value: (data?.stats?.adulti || 0) + (data?.stats?.copii || 0) },
    { label: 'Cazare', value: data?.stats?.cazare || 0 },
    { label: 'Transport', value: data?.stats?.transport || 0 },
  ];
