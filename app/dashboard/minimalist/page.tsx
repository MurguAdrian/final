...
export default function MinimalistDashboard() {
  ...
  if (loading) return (
    <>
      ...
      `}</style>
      <div style={{
        background: '#F7F4F0', height: '100dvh', width: '100vw',
        display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16
      }}>
        <div style={{
          width: 32, height: 32, border: '1.5px solid rgba(17,17,17,.15)',
          borderTopColor: '#C8503A', borderRadius: '50%',
          animation: 'mn-spin 1s linear infinite'
        }} />
        <span style={{
          fontFamily: "'DM Sans', sans-serif", fontSize: 10, letterSpacing: '.28em',
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mn-tab:hover { background: rgba(200,80,58,.07) !important; color: #C8503A !important; }
        .mn-tab-active { background: #fff !important; color: #111 !important; border-color: #E2E2E2 !important; border-left: 3px solid #C8503A !important; }

        .mn-signout { transition: background .2s, border-color .2s, color .2s; }
        .mn-signout:hover { background: rgba(200,80,58,.08) !important; border-color: rgba(200,80,58,.4) !important; color: #C8503A !important; }
      ...
      <div className="mn-app-shell">
        ...
        <div style={{
          ...
          background: `radial-gradient(ellipse 60% 50% at 80% 20%, rgba(200,80,58,.04) 0%, transparent 60%)`
        }} />

        {/* ══ MOBILE / TABLET HEADER ══ */}
        <header className="mn-mobile-header" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
            <div style={{
              ...
              padding: '4px 9px', border: `1px solid ${isProfileComplete ? RULE : 'rgba(200,80,58,.3)'}`,
              fontFamily: "'DM Sans', sans-serif", fontSize: 8, letterSpacing: '.18em', textTransform: 'uppercase',
              color: isProfileComplete ? MID : ACCENT,
              whiteSpace: 'nowrap', background: '#fff'
            }}>
              <div style={{
                width: 5, height: 5, borderRadius: '50%', flexShrink: 0,
                background: isProfileComplete ? '#5a9a6a' : ACCENT,
        ...
        <aside className="mn-sidebar" style={{
          ...
          {/* Logo */}
          <div style={{ padding: '0 24px 24px', borderBottom: `1px solid ${RULE}`, paddingLeft: 28 }}>
          ...
          {/* Nav */}
          <nav style={{ flex: 1, padding: '18px 14px 18px 14px', display: 'flex', flexDirection: 'column', gap: 2 }}>
            <p style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: 8, letterSpacing: '.28em',
            ...
            {tabs.map(tab => (
              <button
                ...
                style={{
                  ...
                  color: activeTab === tab.id ? DARK : MID,
          ...
          <div style={{ padding: '0 14px 0 14px' }}>
            <div style={{
              ...
              background: '#F7F4F0',
              border: `1px solid ${isProfileComplete ? RULE : 'rgba(200,80,58,.3)'}`,
              borderLeft: `3px solid ${isProfileComplete ? '#5a9a6a' : ACCENT}`,
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: isProfileComplete ? 6 : 0 }}>
                ...
                <span style={{
                  fontFamily: "'DM Sans', sans-serif", fontSize: 8, letterSpacing: '.2em',
                  textTransform: 'uppercase', color: isProfileComplete ? '#5a9a6a' : ACCENT
                }}>{isProfileComplete ? 'Link Activ' : 'Configurare Necesară'}</span>
              </div>
              {isProfileComplete && (
                <p style={{
                  fontFamily: "'DM Sans', sans-serif", fontSize: 10,
                  color: LIGHT, wordBreak: 'break-all', lineHeight: 1.5
                }}>
            ...
            <p style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: 8, letterSpacing: '.2em',
              textTransform: 'uppercase', color: '#DDDDDD',
              textAlign: 'center', marginTop: 14
            }}>VibeInvite · Tema Minimal © 2026</p>
          </div>
        </aside>
        ...
        <nav className="mn-tablet-nav" style={{
        ...
        {/* ══ PHONE BOTTOM NAV ══ */}
        <nav className="mn-mobile-nav" style={{
          ...
          {tabs.map(tab => (
            <button
              ...
              style={{
                ...
                borderTop: activeTab === tab.id ? `2px solid ${ACCENT}` : '2px solid transparent',
                color: activeTab === tab.id ? ACCENT : LIGHT,
              ...
              <span style={{
                fontFamily: "'DM Sans', sans-serif", fontSize: 8, letterSpacing: '.08em',
