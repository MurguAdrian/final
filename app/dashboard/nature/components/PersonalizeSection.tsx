  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Swal.fire({
          title: '<span style="color: #274422; font-family: serif;">Salvat! 🌱</span>',
        ...
        if (res.status === 409 || err.error?.toLowerCase().includes('exist') || err.error?.toLowerCase().includes('link')) {
          Swal.fire({
            title: '<span style="color: #274422; font-family: serif;">Link rezervat 🍃</span>',
          ...
          Swal.fire({
            title: '<span style="color: #274422; font-family: serif;">Eroare la salvare 🌿</span>',
...
.ps-gen-btn:hover:not(:disabled) {
  background: rgba(46, 139, 87, .13) !important; /* Verde SeaGreen soft */
  border-color: rgba(46, 139, 87, .5) !important;
  color: rgba(34, 110, 67, .95) !important;       /* Verde închis pentru text */
}
.ps-test-btn:hover {
  background: rgba(46, 139, 87, .14) !important;
  border-color: rgba(46, 139, 87, .45) !important;
  color: rgba(34, 110, 67, .95) !important;
}
