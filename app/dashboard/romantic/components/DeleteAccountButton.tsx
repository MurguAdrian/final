  ...
  const modal = (
    ...
    >
      ...
      >
        ...
        <h3 style={{
          fontFamily: F.heading, fontSize: 18, fontWeight: 500, color: '#5A3020',
          textAlign: 'center', margin: `0 0 10px`, letterSpacing: '.06em',
        }}>
          Șterge Contul
        </h3>
        ...
        <p style={{
          fontSize: FS.md, color: 'rgba(90,48,32,.65)',
        ...
        <label style={{
          ...
          <input
            ...
            style={{ marginTop: 2, accentColor: '#C4785A', width: 15, height: 15, flexShrink: 0 }}
          />
          <span style={{ fontSize: FS.md, color: 'rgba(90,48,32,.75)', lineHeight: 1.55 }}>
            Înțeleg că datele mele vor fi șterse definitiv și că nu voi primi banii înapoi.
          </span>
        </label>
