      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .ps-gen-btn:hover:not(:disabled) {
          background: rgba(196,80,106,.13) !important;
          border-color: rgba(196,80,106,.5) !important;
          color: rgba(166,50,72,.95) !important;
        }
        .ps-test-btn:hover {
          background: rgba(196,80,106,.14) !important;
          border-color: rgba(196,80,106,.45) !important;
          color: rgba(166,50,72,.95) !important;
        }
