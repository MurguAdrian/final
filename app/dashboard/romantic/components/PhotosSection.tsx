...
// //         .rose-btn:hover                  { transform: translateY(-2px); box-shadow: 0 14px 40px rgba(166,50,72,.38) !important; }
...
// //         @keyframes rm-fade-in  { from{ opacity: 0; transform: translateY(8px) } to{ opacity: 1; transform: translateY(0) } }
...
// //               <rect x="4" y="14" width="40" height="28" rx="5" stroke="#A63248" strokeWidth="1.8" strokeOpacity=".7" />
...
// //                   <circle cx="20" cy="20" r="18" stroke="#A63248" strokeWidth="1.5" strokeOpacity=".35" />
// //                   <path d="M20 12 L20 22 M20 27 L20 28" stroke="#A63248" strokeWidth="2" strokeLinecap="round" />
// //                 </svg>
// //               </div>
...
// //                 className="rose-btn"
// //                 style={{ ...styles.roseBtn, opacity: consentChecked ? 1 : 0.45, cursor: consentChecked ? 'pointer' : 'not-allowed', transition: 'all .25s' }}
// //               >
...
// //           <div style={{ marginTop: 28, animation: 'rm-fade-in .5s ease both' }}>
...
// //                     className="rose-btn dl-all-btn"
// //                     style={{ ...styles.roseBtn, padding: '9px 18px', fontSize: 11, gap: 7, transition: 'all .25s', opacity: downloadingAll ? 0.7 : 1, width: 'auto' }}
// //                   >
// //                     {downloadingAll ? (
// //                       <>
...
// //                   {loading ? (
// //                     <svg viewBox="0 0 16 16" fill="none" style={{ width: 13, height: 13, animation: 'spin 1s linear infinite', flexShrink: 0 }}>
// //                       <circle cx="8" cy="8" r="6" stroke="#A63248" strokeWidth="1.8" strokeDasharray="20 10" />
// //                     </svg>
// //                   ) : (
// //                     <svg viewBox="0 0 16 16" fill="none" style={{ width: 13, height: 13, flexShrink: 0 }}>
// //                       <path d="M2 8C2 4.68 4.68 2 8 2s6 2.68 6 6-2.68 6-6 6" stroke="#A63248" strokeWidth="1.6" strokeLinecap="round" />
// //                       <path d="M2 8 L4.5 5.5 M2 8 L4.5 10.5" stroke="#A63248" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
// //                     </svg>
// //                   )}
// //                   Actualizează
// //                 </button>
...
// //                   <rect x="4" y="14" width="40" height="28" rx="5" stroke="#A63248" strokeWidth="1.5" />
// //                   <path d="M14 14 L17 8 L31 8 L34 14" stroke="#A63248" strokeWidth="1.5" strokeLinejoin="round" />
// //                   <circle cx="24" cy="28" r="8" stroke="#A63248" strokeWidth="1.2" />
// //                 </svg>
// //                 <p style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 15, fontStyle: 'italic', color: 'rgba(166,50,72,.38)', marginBottom: 4 }}>
// //                   Nicio fotografie încărcată de invitați
// //                 </p>
// //                 <p style={{ fontFamily: "'Cinzel',serif", fontSize: 9, letterSpacing: '.18em', color: 'rgba(166,50,72,.22)', marginBottom: 0 }}>
...
// //                         ) : (
// //                           <svg viewBox="0 0 16 16" fill="none" style={{ width: 13, height: 13, flexShrink: 0 }}>
// //                             <path d="M8 2 L8 10 M4 7 L8 11 L12 7" stroke="#A63248" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
// //                             <path d="M2 13.5 L14 13.5" stroke="#A63248" strokeWidth="1.6" strokeLinecap="round" />
// //                           </svg>
// //                         )}
...
// //                         <svg viewBox="0 0 16 16" fill="none" style={{ width: 13, height: 13, flexShrink: 0 }}>
// //                           <path d="M1 8C1 8 3.5 3 8 3s7 5 7 5-2.5 5-7 5S1 8 1 8z" stroke="rgba(166,50,72,.7)" strokeWidth="1.4" />
// //                           <circle cx="8" cy="8" r="2" stroke="rgba(166,50,72,.7)" strokeWidth="1.4" />
// //                         </svg>
// //                         Vezi Full
// //                       </a>
// //                     </div>
...
// // const RoseDivider = () => (
// //   <div style={{ display: 'flex', alignItems: 'center', width: '100%', margin: '14px 0 20px' }}>
// //     <div style={{ flex: 1, height: 1, background: 'linear-gradient(90deg,transparent,rgba(196,80,106,.28))' }} />
// //     <svg viewBox="0 0 60 20" width="50" height="16" fill="none" style={{ flexShrink: 0 }}>
// //       <path d="M5 10 L20 10" stroke="#A63248" strokeWidth=".8" strokeOpacity=".45" />
// //       <path d="M40 10 L55 10" stroke="#A63248" strokeWidth=".8" strokeOpacity=".45" />
// //       <path d="M30 4 Q34 7 34 10 Q34 13 30 16 Q26 13 26 10 Q26 7 30 4Z" fill="none" stroke="#A63248" strokeWidth="1" strokeOpacity=".75" />
// //       <circle cx="30" cy="10" r="1.8" fill="#A63248" fillOpacity=".6" />
// //     </svg>
// //     <div style={{ flex: 1, height: 1, background: 'linear-gradient(90deg,rgba(196,80,106,.28),transparent)' }} />
// //   </div>
// // );

// // const G = {
// //   rose:       '#A63248',
// //   roseDim:   'rgba(166,50,72,.5)',
// //   roseFaint: 'rgba(196,80,106,.08)',
// //   roseBorder:'rgba(196,80,106,.18)',
// //   text:      '#3D1520',
// //   textDim:   'rgba(61,21,32,.5)',
// // };
...
// //   headerLabel: { fontFamily: "'Cinzel',serif", fontSize: 9, letterSpacing: '.3em', textTransform: 'uppercase', color: G.roseDim, marginBottom: 4 },
// //   title: { fontFamily: "'Cormorant Garamond',serif", fontSize: 'clamp(22px,4vw,34px)', fontWeight: 300, fontStyle: 'italic', color: G.rose, margin: 0, letterSpacing: '.04em' },
// //   headerIcon: { width: 48, height: 48, borderRadius: 12, background: G.roseFaint, border: `1px solid ${G.roseBorder}`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
// //   card: { background: 'rgba(196,80,106,.03)', border: `1px solid ${G.roseBorder}`, borderRadius: 14, overflow: 'hidden', marginBottom: 14 },
// //   cardInner: { padding: 'clamp(16px,3vw,24px)', display: 'flex', flexDirection: 'column', gap: 10 },
// //   statusIconWrap: { width: 48, height: 48, borderRadius: '50%', background: G.roseFaint, border: `1px solid ${G.roseBorder}`, display: 'flex', alignItems: 'center', justifyContent: 'center' },
...
// //   consentLabel: { display: 'flex', alignItems: 'flex-start', gap: 12, cursor: 'pointer', padding: '12px 14px', background: 'rgba(196,80,106,.04)', border: `1px solid ${G.roseBorder}`, borderRadius: 10 },
// //   checkbox: { width: 18, height: 18, borderRadius: 4, border: '1.5px solid rgba(196,80,106,.35)', background: 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1, transition: 'all .2s' },
// //   checkboxChecked: { background: '#A63248', borderColor: '#A63248' },
// //   consentText: { fontFamily: "'Cinzel',serif", fontSize: 10, letterSpacing: '.06em', color: 'rgba(166,50,72,.65)', lineHeight: 1.6 },
// //   roseBtn: { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px 20px', borderRadius: 8, background: 'linear-gradient(135deg,#7B1A2E 0%,#A63248 50%,#C4506A 100%)', color: '#fff', fontFamily: "'Cinzel',serif", fontSize: 11, fontWeight: 700, letterSpacing: '.16em', textTransform: 'uppercase', border: 'none', cursor: 'pointer', boxShadow: '0 6px 22px rgba(123,26,46,.25)', width: '100%' } as React.CSSProperties,
// //   ghostBtn: { display: 'inline-flex', alignItems: 'center', gap: 7, padding: '9px 16px', borderRadius: 8, background: G.roseFaint, border: `1px solid ${G.roseBorder}`, color: G.rose, fontFamily: "'Cinzel',serif", fontSize: 10, fontWeight: 600, letterSpacing: '.12em', cursor: 'pointer', whiteSpace: 'nowrap' } as React.CSSProperties,
// //   statusBadgeActive: { display: 'inline-flex', alignItems: 'center', gap: 8, padding: '5px 14px', borderRadius: 100, background: 'rgba(76,175,80,.09)', border: '1px solid rgba(76,175,80,.28)', fontFamily: "'Cinzel',serif", fontSize: 10, letterSpacing: '.18em', textTransform: 'uppercase', color: '#5a9e5d' },
...
// //   gallerySubCount: { fontFamily: "'Cinzel',serif", fontSize: 9, letterSpacing: '.22em', textTransform: 'uppercase', color: G.roseDim, marginTop: 2, marginBottom: 0 },
// //   photoCard: { position: 'relative', aspectRatio: '1', borderRadius: 10, overflow: 'hidden', border: `1px solid ${G.roseBorder}`, background: '#FDF5F6', cursor: 'pointer' } as React.CSSProperties,
// //   photoImg: { width: '100%', height: '100%', objectFit: 'cover', display: 'block', transition: 'transform .4s ease' } as React.CSSProperties,
// //   photoOverlay: { position: 'absolute', inset: 0, background: 'linear-gradient(to top,rgba(61,21,32,.88) 0%,rgba(61,21,32,.35) 50%,transparent 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', gap: 5, padding: 8, opacity: 0, transition: 'opacity .3s ease' } as React.CSSProperties,
// //   dlBtn: { display: 'inline-flex', alignItems: 'center', gap: 5, padding: '6px 12px', borderRadius: 6, background: 'rgba(253,245,246,.85)', border: '1px solid rgba(196,80,106,.28)', color: '#A63248', fontFamily: "'Cinzel',serif", fontSize: 9, fontWeight: 600, letterSpacing: '.1em', cursor: 'pointer', width: '100%', justifyContent: 'center', transition: 'all .2s' } as React.CSSProperties,
// //   viewBtn: { display: 'inline-flex', alignItems: 'center', gap: 5, padding: '5px 12px', borderRadius: 6, background: 'rgba(253,245,246,.55)', border: '1px solid rgba(196,80,106,.2)', color: 'rgba(166,50,72,.7)', fontFamily: "'Cinzel',serif", fontSize: 9, letterSpacing: '.1em', textDecoration: 'none', width: '100%', justifyContent: 'center', transition: 'all .2s' } as React.CSSProperties,
// //   emptyState: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', background: 'rgba(196,80,106,.03)', border: '1px dashed rgba(196,80,106,.18)', borderRadius: 14, textAlign: 'center' } as React.CSSProperties,
// // };
...
//   headerLabel:   { fontFamily: F.heading, fontSize: FS.tiny, letterSpacing: '.3em', textTransform: 'uppercase', color: 'rgba(166,50,72,.5)', marginBottom: SP.xs },
...
//   card:          { background: 'rgba(196,80,106,.03)', border: `1px solid ${C.borderMed}`, borderRadius: BR.xl, overflow: 'hidden', marginBottom: 14 },
...
//   consentLabel:  { display: 'flex', alignItems: 'flex-start', gap: BR.lg, cursor: 'pointer', padding: `12px 14px`, background: 'rgba(196,80,106,.04)', border: `1px solid ${C.borderMed}`, borderRadius: BR.md },
//   checkbox:      { width: 18, height: 18, border: `1.5px solid rgba(196,80,106,.35)`, background: 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1, transition: 'all .2s' },
//   checkboxChecked:{ background: C.rose, borderColor: C.rose },
//   consentText:   { fontFamily: F.heading, fontSize: FS.xs, letterSpacing: '.06em', color: 'rgba(166,50,72,.65)', lineHeight: 1.6 },
...
//   gallerySubCount:{ fontFamily: F.heading, fontSize: FS.tiny, letterSpacing: '.22em', textTransform: 'uppercase', color: 'rgba(166,50,72,.5)', marginTop: 2, marginBottom: 0 },
...
//   photoImg:      { width: '100%', height: '100%', objectFit: 'cover', display: 'block', transition: 'transform .4s ease' } as React.CSSProperties,
//   photoOverlay:  { position: 'absolute', inset: 0, background: `linear-gradient(to top,rgba(61,21,32,.88) 0%,rgba(61,21,32,.35) 50%,transparent 100%)`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', gap: 5, padding: SP.sm, opacity: 0, transition: 'opacity .3s ease' } as React.CSSProperties,
//   dlBtn:         { display: 'inline-flex', alignItems: 'center', gap: 5, padding: `6px 12px`, borderRadius: BR.sm, background: 'rgba(253,245,246,.85)', border: `1px solid rgba(196,80,106,.28)`, color: C.rose, fontFamily: F.heading, fontSize: FS.tiny, fontWeight: 600, letterSpacing: '.1em', cursor: 'pointer', width: '100%', justifyContent: 'center', transition: 'all .2s' } as React.CSSProperties,
//   viewBtn:       { display: 'inline-flex', alignItems: 'center', gap: 5, padding: `5px 12px`, borderRadius: BR.sm, background: 'rgba(253,245,246,.55)', border: `1px solid rgba(196,80,106,.2)`, color: 'rgba(166,50,72,.7)', fontFamily: F.heading, fontSize: FS.tiny, letterSpacing: '.1em', textDecoration: 'none', width: '100%', justifyContent: 'center', transition: 'all .2s' } as React.CSSProperties,
//   emptyState:    { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: `40px ${SP.xl}px`, background: 'rgba(196,80,106,.03)', border: '1px dashed rgba(196,80,106,.18)', borderRadius: BR.xl, textAlign: 'center' } as React.CSSProperties,
// };
...
//         body: JSON.stringify({
//           orderId,
//           isPhotosActive: true, gallery_status: 'active',
//           photos_activated_at: new Date().toISOString(),
...
//             <svg viewBox="0 0 48 48" fill="none" style={{ width: ph.headerIcon.width as number * 0.54, height: ph.headerIcon.height as number * 0.54 }}>
...
//                     disabled={downloadingAll}
//                     className="rose-btn dl-all-btn"
//                     style={{ ...ph.roseBtn, padding: `9px 18px`, fontSize: FS.base, gap: 7, transition: 'all .25s', opacity: downloadingAll ? 0.7 : 1, width: 'auto' }}
//                   >
//                     {downloadingAll ? (
...
//                 </svg>
//                 <p style={{ fontFamily: F.body, fontSize: FS.base + 2, fontStyle: 'italic', color: 'rgba(166,50,72,.38)', marginBottom: SP.xs }}>
//                   Nicio fotografie încărcată de invitați
//                 </p>
//                 <p style={{ fontFamily: F.heading, fontSize: FS.tiny, letterSpacing: '.18em', color: 'rgba(166,50,72,.22)', marginBottom: 0 }}>
//                   IMAGINILE TRIMISE DE INVITAȚI VOR APĂREA INSTANT AICI
//                 </p>
//               </div>
//             ) : (
          ...
          <div style={{ marginTop: SP.xxxl, animation: 'rm-fade-in .5s ease both' }}>
            ...
            {photos.length === 0 && !loading ? (
              <div style={ph.emptyState}>
                ...
                <p style={{ fontFamily: F.body, fontSize: FS.base + 2, fontStyle: 'italic', color: 'rgba(166,50,72,.38)', marginBottom: SP.xs }}>Nicio fotografie încărcată de invitați</p>
                <p style={{ fontFamily: F.heading, fontSize: FS.tiny, letterSpacing: '.18em', color: 'rgba(166,50,72,.22)', marginBottom: 0 }}>IMAGINILE TRIMISE DE INVITAȚI VOR APĂREA INSTANT AICI</p>
              </div>
            ) : (
              <div className="gallery-grid">
                {photos.map((p: Photo) => (
