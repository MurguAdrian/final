...
import BaloaneClient from './BaloaneClient';
...
export async function generateMetadata(
  ...
  const url = `${baseUrl}/invitatie/baloane/${params.slug}`;
  const ogImage = `${baseUrl}/api/og/baloane/${params.slug}`;
...
export default async function BaloaneInvitationPage({ params }: { params: { slug: string } }) {
  const sql = neon(process.env.DATABASE_URL!);
