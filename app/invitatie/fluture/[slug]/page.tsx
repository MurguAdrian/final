...
import FlutureClient from './FlutureClient';
...
export async function generateMetadata(
  ...
  const url = `${baseUrl}/invitatie/fluture/${params.slug}`;
  const ogImage = `${baseUrl}/api/og/fluture/${params.slug}`;
...
export default async function FlutureInvitationPage({ params }: { params: { slug: string } }) {
  const sql = neon(process.env.DATABASE_URL!);
