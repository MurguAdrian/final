    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lux-scene-corner { position: absolute; width: min(180px, 22vw); height: min(180px, 22vw); opacity: 0.65; pointer-events: none; }
        .lux-scene-corner.tl { top: 0; left: 0; }
        .lux-scene-corner.tr { top: 0; right: 0; transform: scaleX(-1); }
        .lux-scene-corner.bl { bottom: 0; left: 0; transform: scaleY(-1); }
        .lux-scene-corner.br { bottom: 0; right: 0; transform: scale(-1); }

        .lux-scene-line { position: absolute; left: 5%; right: 5%; height: 1px; background: linear-gradient(90deg, transparent, rgba(212,175,55,.22), transparent); pointer-events: none; }
        .lux-scene-line.top { top: 10%; }
        .lux-scene-line.bottom { bottom: 10%; }
