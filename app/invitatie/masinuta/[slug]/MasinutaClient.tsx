...
export default function MasinutaClient(props: Props) {
  ...
  return (
    <>
      ...
      <header style={{ position:'fixed', top:0, left:0, right:0, zIndex:200, height:56, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 clamp(16px,4vw,28px)', background:'rgba(234,244,252,.93)', borderBottom:'1px solid rgba(110,150,190,.16)', backdropFilter:'blur(14px)' }}>
