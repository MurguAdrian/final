...
import MasinutaClient from './MasinutaClient';
...
export async function generateMetadata(
  ...
  const url = `${baseUrl}/invitatie/masinuta/${params.slug}`;
  const ogImage = `${baseUrl}/api/og/masinuta/${params.slug}`;
...
export default async function MasinutaInvitationPage({ params }: { params: { slug: string } }) {
  const sql = neon(process.env.DATABASE_URL!);
