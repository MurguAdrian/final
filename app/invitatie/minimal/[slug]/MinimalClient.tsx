      ...
      {galleryModal && (
        <div onClick={() => setGalleryModal(false)} style={MODAL_OVERLAY}>
          <div onClick={(e) => e.stopPropagation()} style={{ ...MODAL_BOX, maxWidth: 400, textAlign: 'center' }}>
            ...
            <a href={`/invitatie/minimal/${slug}/upload`} style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '13px 32px', borderRadius: 4, background: 'linear-gradient(135deg,#8B6914 0%,#D4AF37 45%,#F5D678 55%,#D4AF37 70%,#8B6914 100%)', color: '#0A0803', textDecoration: 'none', fontFamily: "'Cinzel',serif", fontSize: 11, fontWeight: 700, letterSpacing: '.18em', textTransform: 'uppercase', boxShadow: '0 8px 28px rgba(212,175,55,.3)', marginBottom: 16 }}>📷 Încarcă Pozele</a>
            <br />
...
export default function MinimalInviteClient(props: MinimalInviteClientProps) {
