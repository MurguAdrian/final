...
// ── ACCENT COLOR — warm terracotta/blush (matching Minimal theme)
const ACCENT = '#C8503A';
const DARK = '#111111';
const MID = '#555555';
const LIGHT = '#AAAAAA';
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Left accent stripe — consistent with Minimal theme */
        .upload-page::before {
          content: '';
          position: fixed;
          top: 0;
          ...
          {uploaded ? (
            <>
              ...
              <p className="upload-success-text">
                Pozele au fost trimise cu succes mirilor.<br />Abia așteptăm să le vedem!
              </p>
            </>
          ) : (
            <>
