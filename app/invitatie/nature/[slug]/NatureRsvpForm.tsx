          ...
          <div style={{ background: 'rgba(154,123,63,.06)', border: '1.5px solid rgba(154,123,63,.15)', borderRadius: '10px', padding: '12px 14px', marginBottom: '18px', marginTop: '22px' }}>
            ...
            <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', cursor: 'pointer', userSelect: 'none' }}>
              <input 
                ...
                style={{ marginTop: '3px', width: '16px', height: '16px', cursor: 'pointer', accentColor: '#3A5E33' }}
              />
              <span style={{ fontFamily: "'Cormorant', serif", fontSize: '12px', color: '#1C2218', fontStyle: 'italic', lineHeight: '1.5' }}>
