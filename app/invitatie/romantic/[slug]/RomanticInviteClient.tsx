      ...
      <div style={{ position: 'relative', zIndex: 10, maxWidth: 700, margin: '0 auto', padding: 'clamp(36px,6vw,64px) clamp(16px,4vw,32px) 60px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
        ...
        {hasAnyParents && (
          <div style={{ ...a(0.3), textAlign: 'center', marginTop: 14, marginBottom: 4 }}>
            ...
            {displayParentsBride && (
              <p style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 'clamp(14px,1.6vw,16px)', fontStyle: 'italic', fontWeight: 300, color: `rgba(61,21,32,.65)`, marginBottom: displayParentsGroom ? 4 : 0 }}>
                {displayParentsBride}
              </p>
            )}
            {displayParentsGroom && (
              <p style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 'clamp(14px,1.6vw,16px)', fontStyle: 'italic', fontWeight: 300, color: `rgba(61,21,32,.65)`, marginBottom: 0 }}>
                {displayParentsGroom}
              </p>
            )}
          </div>
