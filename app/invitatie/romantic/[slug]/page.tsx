...
export async function generateMetadata(
  ...
  const url = `https://vibeinvite.ro/invitatie/romantic/${params.slug}`;
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      siteName: 'VibeInvite',
      images: [{ url: '/og-romantic.jpg', width: 1200, height: 630, alt: title }],
      locale: 'ro_RO',
    },
    twitter: { card: 'summary_large_image', title, description, images: ['/og-romantic.jpg'] },
