...
//         .rup-corner { position: absolute; width: min(160px, 20vw); height: min(160px, 20vw); opacity: .55; pointer-events: none; }
...
//         .rup-line { position: absolute; left: 5%; right: 5%; height: 1px; background: linear-gradient(90deg, transparent, rgba(200,216,232,.2), transparent); pointer-events: none; }
//         .rup-line.top { top: 8%; }
...
//           text-align: center;
//           animation: rup-cardReveal .6s cubic-bezier(.4,0,.2,1) both;
//           overflow: hidden;
//         }
//         .rup-card-top-line { position: absolute; top: 0; left: 10%; right: 10%; height: 1px; background: linear-gradient(90deg, transparent, rgba(200,216,232,.45), transparent); }
...
//         .rup-camera-circle { width: clamp(64px, 12vw, 80px); height: clamp(64px, 12vw, 80px); border-radius: 50%; background: rgba(124,168,216,.1); border: 2px solid rgba(200,216,232,.26); display: flex; align-items: center; justify-content: center; margin: 0 auto clamp(16px, 3vw, 24px); }
//         .rup-eyebrow { font-family: 'Cinzel', serif; font-size: clamp(8px, 1vw, 10px); letter-spacing: .32em; text-transform: uppercase; color: rgba(200,216,232,.55); margin-bottom: 10px; }
//         .rup-title { font-family: 'Cormorant Garamond', serif; font-size: clamp(26px, 4vw, 34px); font-style: italic; font-weight: 300; color: #E8F0F8; margin-bottom: 10px; line-height: 1.2; }
//         .rup-divider { width: 40px; height: 1px; background: linear-gradient(90deg, transparent, rgba(200,216,232,.45), transparent); margin: 0 auto 18px; }
//         .rup-desc { font-size: clamp(13px, 1.6vw, 16px); font-style: italic; color: rgba(200,216,232,.55); line-height: 1.8; margin-bottom: 24px; }

//         .rup-consent-block { display: flex; align-items: flex-start; gap: 12px; background: rgba(124,168,216,.04); border: 1px solid rgba(200,216,232,.15); border-radius: 10px; padding: 14px 16px; margin-bottom: 24px; text-align: left; cursor: pointer; transition: border-color .2s, background .2s; }
...
//         .rup-consent-text { font-family: 'Cormorant Garamond', serif; font-size: clamp(12px, 1.5vw, 14px); font-style: italic; color: rgba(200,216,232,.6); line-height: 1.7; cursor: pointer; }
...
//           color: #E8F0F8;
//           font-family: 'Cinzel', serif; font-size: clamp(10px, 1.3vw, 13px); font-weight: 700;
...
//         }
//         .rup-upload-btn::after { content: ''; position: absolute; inset: 0; background: linear-gradient(90deg, transparent, rgba(255,255,255,.12), transparent); background-size: 350px 100%; animation: rup-shimmer 3s linear infinite; }
//         .rup-upload-btn:not(:disabled):hover { transform: translateY(-2px); box-shadow: 0 14px 44px rgba(4,18,40,.8), 0 0 30px rgba(124,168,216,.25); }
//         .rup-upload-btn:disabled { opacity: .3; cursor: not-allowed; background: rgba(124,168,216,.2); box-shadow: none; }
//         .rup-upload-btn span { position: relative; z-index: 1; }

//         .rup-success-icon { display: flex; justify-content: center; margin-bottom: 16px; }
//         .rup-success-title { font-family: 'Cormorant Garamond', serif; font-size: clamp(24px, 4vw, 32px); font-style: italic; font-weight: 300; color: #E8F0F8; margin-bottom: 10px; }
//         .rup-success-text { font-style: italic; font-size: clamp(14px, 1.7vw, 17px); color: rgba(200,216,232,.6); line-height: 1.8; }
//         .rup-footer { font-family: 'Cinzel', serif; font-size: clamp(7px, .9vw, 9px); letter-spacing: .2em; text-transform: uppercase; color: rgba(200,216,232,.25); margin-top: clamp(20px, 3vw, 28px); }
//         .rup-spinner { display: inline-block; width: 16px; height: 16px; border: 2px solid rgba(232,240,248,.3); border-top-color: #E8F0F8; border-radius: 50%; animation: rup-spin .7s linear infinite; vertical-align: middle; margin-right: 8px; }

//         @keyframes rup-cardReveal { from { opacity: 0; transform: translateY(24px) scale(.97); } to { opacity: 1; transform: translateY(0) scale(1); } }
//         @keyframes rup-shimmer { 0% { background-position: -350px 0; } 100% { background-position: 350px 0; } }
//         @keyframes rup-spin { to { transform: rotate(360deg); } }
//       `}</style>

//       <div className="royal-upload-page">
//         {/* Palace corners */}
//         <svg className="rup-corner tl" viewBox="0 0 160 160" fill="none">
...
//           </defs>
//         </svg>
//         <svg className="rup-corner tr" viewBox="0 0 160 160" fill="none">
...
//           </defs>
//         </svg>
//         <svg className="rup-corner bl" viewBox="0 0 160 160" fill="none">
...
//           </defs>
//         </svg>
//         <svg className="rup-corner br" viewBox="0 0 160 160" fill="none">
...
//         <div className="royal-upload-card">
...
//               <h2 className="rup-title">Mulțumim! ✦</h2>
//               <div className="rup-divider"/>
//               <p className="rup-success-text">Pozele au fost trimise cu succes mirilor.<br/>Abia așteptăm să le vedem!</p>
//             </>
//           ) : (
//             <>
...
//               <div className="rup-divider"/>
//               <p className="rup-desc">Fotografiile sunt destinate exclusiv mirilor și vor fi disponibile în albumul online pe toată durata existenței evenimentului.</p>
...
//                 />
//                 <span className="rup-consent-text">Confirm că am acordul persoanelor din fotografii și sunt de acord cu stocarea acestora în albumul privat al mirilor.</span>
//               </label>
//               {agreed ? (
//                 <label className="rup-upload-btn" style={{cursor:'pointer'}}>
//                   <span>
//                     {uploading
...
//                 </label>
//               ) : (
//                 <button className="rup-upload-btn" disabled style={{cursor:'not-allowed'}}>
