...
export default function UrsuletInviteClient(props: Props) {
  ...
  return (
    <>
      ...
      <header style={{ position:'fixed', top:0, left:0, right:0, zIndex:200, height:56, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 clamp(16px,4vw,28px)', background:'rgba(254,252,247,.93)', borderBottom:'1px solid rgba(122,170,192,.16)', backdropFilter:'blur(14px)' }}>
        ...
        <div style={{ fontFamily:"'Cormorant',serif", fontSize:15, fontStyle:'italic', color:'#A07850', letterSpacing:'.04em', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap', maxWidth:'40%', textAlign:'center' }}>
