...
import UrsuletInviteClient from './UrsuletInviteClient';
...
export async function generateMetadata(
  ...
  const url = `${baseUrl}/invitatie/ursulet/${params.slug}`;
  const ogImage = `${baseUrl}/api/og/ursulet/${params.slug}`;
...
export default async function UrsuletInvitationPage({ params }: { params: { slug: string } }) {
  const sql = neon(process.env.DATABASE_URL!);
