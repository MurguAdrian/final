      ...
      if (res.ok) {
        const themeRoutes: Record<string, string> = {
          ...
          romantic: "/dashboard/romantic",
            // ── botez ──
  steluta:    "/dashboard/steluta",
  astronaut:  "/dashboard/astronaut",
  masinuta:   "/dashboard/masinuta",
  ursulet:    "/dashboard/ursulet",
  fluture:    "/dashboard/fluture",
  baloane:    "/dashboard/baloane",
        };
