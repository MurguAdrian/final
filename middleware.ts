...
const SKIP = new Set([
  ...
  'success','termeni','api','_next','favicon.ico','robots.txt','sitemap.xml','fotograf-ploiesti-jo-photography','fotograf-targoviste-bianca-sfetcu','fotograf-craiova-fotoali',
]);
